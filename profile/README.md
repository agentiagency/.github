...
> _last updated: Mon, 02 Mar 2026 04:11:01 GMT_

| repo | 🐛 issues | 🔀 prs | main CI | latest PR CI |
|------|-----------|--------|---------|--------------|
| [**agenticlaw**](https://github.com/agentiagency/agenticlaw) | 15 | 15 | 🟡 `6/7` | ⚪ `0/0` [#25](https://github.com/agentiagency/agenticlaw/pull/25) |
