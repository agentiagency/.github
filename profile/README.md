...
> _last updated: Mon, 02 Mar 2026 07:46:21 GMT_

| repo | 🐛 issues | 🔀 prs | main CI | latest PR CI |
|------|-----------|--------|---------|--------------|
| [**agenticlaw**](https://github.com/agentiagency/agenticlaw) | 29 | 15 | 🟢 `3/3` | ⚪ `0/0` [#25](https://github.com/agentiagency/agenticlaw/pull/25) |
